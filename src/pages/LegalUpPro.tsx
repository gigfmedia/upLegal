    ...
    <div className="min-h-screen overflow-x-clip bg-white text-gray-900 antialiased">
      ...
      <section className="bg-white">
        <div className="px-3 py-3 sm:px-6 sm:py-6">
          ...
          <Reveal className="mt-10 flex flex-col items-center justify-between gap-4 rounded-2xl border border-green-200 bg-gradient-to-r from-green-300 via-green-100 to-white px-6 py-5 shadow-md sm:flex-row" delay={0.15}>
            <div className="flex items-center gap-3">
              <Sparkles className="h-5 w-5 shrink-0 text-green-700" />
              <p className="max-w-2xl text-sm text-gray-800 sm:text-base"><span className="font-semibold text-gray-900">IA como capa transversal:</span> disponible en tus casos a lo largo de todo el flujo, no aislada.</p>
            </div>
            <Button onClick={() => handleCTAClick("overview")} className="rounded-full shrink-0 bg-gray-900 text-white hover:bg-green-900">
              Comenzar con LegalUp Pro <ArrowRight className="h-4 w-4" />
            </Button>
          </Reveal>
            </div>
