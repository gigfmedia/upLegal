...
import { ChevronRight, MessageSquare, CheckCircle, ArrowRight, Star, Shield, Clock, ChevronDown } from "lucide-react";
    ...
    <div className="min-h-screen bg-white pt-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Button 
                  size="lg" 
                  className="bg-white hover:bg-green-50 text-gray-900 border-none h-14 px-8 text-lg"
                  onClick={() => {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">
              ¿Por qué elegir un abogado de LegalUp para tu caso {category}?
            </h2>
            <p className="mb-6">
      ...
      <section className="py-20 bg-green-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button 
            size="lg" 
            className="bg-white text-green-900 hover:bg-green-50 h-14 px-10 text-md"
            onClick={() => {
              if (!user) setShowAuthModal(true);
              else window.location.href = '/search';
            }}
