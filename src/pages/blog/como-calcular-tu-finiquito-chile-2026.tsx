  ...
  const faqs = [
    {
      ...
      answer: "La empresa tiene un plazo legal de 10 días hábiles desde el término de la relación laboral."
    },
    {
      question: "¿Se puede firmar el finiquito con reserva de derechos?",
      answer: "Sí, es recomendable escribir de puño y letra qué montos o conceptos no estás de acuerdo antes de firmar."
    },
    {
      question: "¿Qué indemnizaciones incluye el finiquito por necesidades de la empresa?",
      answer: "Incluye años de servicio, mes de aviso (si no se dio) y feriado proporcional."
    }
  ];
