        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-green-900 text-white py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28">
                    ...
                    <h1 className="text-3xl sm:text-4xl font-bold text-green-600 font-serif mb-6">Accidente de tránsito en Chile 2026: quién paga los daños y cómo reclamar</h1>
