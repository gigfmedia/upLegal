...
export function GlobalSearch() {
  ...
  return (
    // z-50 empata con el header (gana por orden DOM) pero queda debajo de
    // drawers/modales (portales al final del body): ni tapa el chat ni se oculta.
    <div className="fixed top-[7px] left-1/2 -translate-x-1/2 z-50 hidden md:flex flex-col items-center">
      <div ref={wrapperRef} className="relative w-[500px] min-w-[500px] max-w-[calc(100vw-32px)]">
