...
const HurtoArticle = lazy(() => import('../pages/blog/hurto-chile-2026'));
const RoboArticle = lazy(() => import('../pages/blog/robo-chile-2026'));
...
const InspeccionTrabajoArticle = lazy(() => import('../pages/blog/inspeccion-del-trabajo-chile-2026'));
const DemandaLaboralArticle = lazy(() => import('../pages/blog/demanda-laboral-chile-2026'));
const NulidadDespidoArticle = lazy(() => import('../pages/blog/nulidad-del-despido-chile-2026'));
...
const ReconocimientoDeudaArticle = lazy(() => import('../pages/blog/reconocimiento-de-deuda-chile-2026'));
...
const AcusacionFalsaArticle = lazy(() => import('../pages/blog/me-acusaron-delito-no-cometi-chile-2026'));
const AmenazasWhatsappArticle = lazy(() => import('../pages/blog/amenazas-whatsapp-chile-2026'));
const AccidenteTransitoArticle = lazy(() => import('../pages/blog/accidente-transito-chile-2026'));
const ConstitucionEmpresaArticle = lazy(() => import('../pages/blog/constitucion-empresa-chile-2026'));
const ContratoCompraventaArticle = lazy(() => import('../pages/blog/contrato-compraventa-chile-2026'));
const UsurpacionArticle = lazy(() => import('../pages/blog/usurpacion-inmueble-chile-2026'));
const LeyEmiliaArticle = lazy(() => import('../pages/blog/manejo-estado-ebriedad-ley-emilia-chile-2026'));
...
export const BlogRoutes = () => (
  <Suspense fallback={
    ...
    <Routes>
      ...
      <Route path="hurto-chile-2026" element={<HurtoArticle />} />
      <Route path="robo-chile-2026" element={<RoboArticle />} />
      ...
      <Route path="inspeccion-del-trabajo-chile-2026" element={<InspeccionTrabajoArticle />} />
      <Route path="demanda-laboral-chile-2026" element={<DemandaLaboralArticle />} />
      <Route path="nulidad-despido-chile-2026" element={<NulidadDespidoArticle />} />
      ...
      <Route path="reconocimiento-de-deuda-chile-2026" element={<ReconocimientoDeudaArticle />} />
      ...
      <Route path="me-acusaron-delito-no-cometi-chile-2026" element={<AcusacionFalsaArticle />} />
      <Route path="amenazas-whatsapp-chile-2026" element={<AmenazasWhatsappArticle />} />
      <Route path="accidente-transito-chile-2026" element={<AccidenteTransitoArticle />} />
      <Route path="constitucion-empresa-chile-2026" element={<ConstitucionEmpresaArticle />} />
      <Route path="contrato-compraventa-chile-2026" element={<ContratoCompraventaArticle />} />
      <Route path="usurpacion-inmueble-chile-2026" element={<UsurpacionArticle />} />
      <Route path="manejo-estado-ebriedad-ley-emilia-chile-2026" element={<LeyEmiliaArticle />} />
